...
def get_response(doc:str,query_str:str,chunk_size:int=1024,chunk_overlap:int=128,verbose:bool=True,use_async:bool=True):
...
def get_summary(docs:List[str],metadata:List[dict],ticker,year,filing_type:str="10-K"):
...
def generate_summary(ticker:str,year:str,filing_type:str):
    ...
    final_summary = get_summary(docs,metadata,ticker,year,filing_type)
